...
<h2 class="page-header" style="text-color:white">Want to Post ?</h2>

<a class="btn btn-primary pull-left" href="/Final_photo_yii2/web/index.php?r=photograph/create">Create Post</a>
