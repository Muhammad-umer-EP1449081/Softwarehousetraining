...
<a><button type="button" class="btn btn-block btn-primary btn-lg">Search Friend.....</button></a>
...
<h2 class="page-header" style="text-color:white">Enter username or Email</h2>
