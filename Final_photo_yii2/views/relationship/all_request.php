...
<div class="mainbar">
          ...
          <div class="article">
            <h2><span>Request Notification</span></h2>
...
<h2 class="page-header" style="text-color:white">All pending request</h2>

<!--
<a class="btn btn-primary pull-left" href="/Final_photo_yii2/web/index.php?r=photograph/create">All pending request</a>
...
$user = User::find()->where(['user_id' => $request->user_id_one])->one();
...
?>
            ...
            <p class="post-data">
                 ...
                 <img src="images/<?php echo $request_user_pic->filename?>" width="70" height="70" alt="" />
            	  Requested by <a href="#"><?php echo $user->username ?></a>
            	  &nbsp;|&nbsp;
            	 <span class="date"><?php echo $request->date?></span>
            	  &nbsp;|&nbsp;

<a  class="btn btn-primary" style="color:white;" href="/Final_photo_yii2/web/index.php?r=relationship/accept&id=<?php echo $request->id ?>">Accept Request</a>
             </p>
